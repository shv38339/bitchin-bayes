...
## Introduction
Based on Andrew Gelman's blog...


What is this about

## Code and Time Series Plots
...
## Next Steps
The final plot shows time series data for the Boston Celtics. Further steps would include specifying the most appropriate ARIMA model, and model diagnostics, **finding and merging data from other sources**, doing those within the bayesian context, and making a multilevel hierarchy structure for different home and visiting teams.
