...
Now, following **Leontine's advice**, we're going to differentiate the rank, b/c it doesn't make sense to keep rank constant. Wow, this is ridiuclous.
```{r rank-differential}
rank.diff <- g1$def.rank[]
```
